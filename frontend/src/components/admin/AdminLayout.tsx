...
const AdminLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      path: '/admin/notification-banners',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Pre-Configured PCs',
      path: '/admin/pre-configured-pcs',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="dark min-h-screen bg-surface-950">
      {/* Top Bar */}
      <div className="bg-surface-900/90 backdrop-blur-xl border-b border-surface-700 shadow-dark-md sticky top-0 z-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <button
                ...
                className="lg:hidden p-2 -ml-2 text-neutral-400 hover:text-white hover:bg-surface-700 rounded-lg transition-colors"
              ...
              <span className="hidden sm:inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-600/10 text-primary-400">
                Admin
              </span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              <span className="text-sm text-neutral-400 font-medium hidden sm:block">
                {user?.firstName} {user?.lastName}
              </span>
              <button
                onClick={() => logoutUser()}
                className="px-3 sm:px-4 py-2 text-sm font-medium text-neutral-400 hover:text-white transition-colors"
              >
                Logout
              </button>
              <Link
                to="/"
                className="hidden sm:inline-flex px-4 py-2 text-sm font-bold text-primary-400 hover:text-primary-400 border border-primary-500/30 rounded-full hover:bg-primary-600/10 transition-all"
              >
                View Site
              </Link>
            </div>
      ...
      <div className="flex">
        ...
        <aside
          className={`
            fixed lg:sticky top-16 left-0 z-40 w-72 lg:w-64
            bg-surface-850 border-r border-surface-700
        ...
        >
          ...
          <div className="lg:hidden border-t border-surface-700 px-3 py-3">
            <Link
              to="/"
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center justify-center px-4 py-2.5 text-sm font-bold rounded-xl transition-all text-primary-400 bg-primary-600/10 border border-primary-500/30 hover:bg-primary-600/20"
            >
              <span className="mr-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
